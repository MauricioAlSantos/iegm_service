...
public class RemessaController {
    ...
    @GetMapping("/remessasValidadasAno")
    public List<Remessa> getAllRemessasValidadasByAno(@Valid @RequestParam Integer ano) {
        System.out.println("Nº remessas:" + remessaService.getAllRemessasValidadasByAno(ano).size());
        return remessaService.getAllRemessasValidadasByAno(ano);
    }
